...
namespace Orbitons
{
    ...
    void UI::init(GLFWwindow *window)
    {
        ...
        // small scope to tidy a little
        {
            ...
            colors[ImGuiCol_Header] = ImVec4(0.76f, 0.35f, 0.22f, 0.8f);
            colors[ImGuiCol_HeaderHovered] = ImVec4(0.76f, 0.35f, 0.22f, 0.3f);
            colors[ImGuiCol_HeaderActive] = ImVec4(0.76f, 0.35f, 0.22f, 1.0f);
